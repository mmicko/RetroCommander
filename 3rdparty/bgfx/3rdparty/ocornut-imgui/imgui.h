...
namespace ImGui
{
    ...
    IMGUI_API bool          SelectableAllColumns(const char* label, bool selected = false, const ImVec2& size = ImVec2(0,0));
    IMGUI_API bool          SelectableAllColumns(const char* label, bool* p_selected, const ImVec2& size = ImVec2(0,0));
